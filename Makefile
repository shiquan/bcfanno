...
bcfanno_pwm: $(HTSLIB) version.h
	$(CC) $(DEBUG_CFLAGS) $(INCLUDES) -pthread -o $@ src2/bed_utils.c src2/motif.c src2/number.c src2/wrap_pileup.c src2/anno_col.c src2/anno_thread_pool.c src2/anno_pool.c $(HTSLIB) $(LIBS)
